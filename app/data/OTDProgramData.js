            ...
            tracks: [
                {
                    ...
                    sessions: [
                        ...
                        },
                        {
                            ...
                            speakers: {
                                en: '',
                                zh: '吳崢 | 林穎孟 | 林鈺傑 | 陳乃嘉 | 楊雅婷',
                            },
                            description: {
                                en: '',
                                zh: '時代力量是國會第三大黨，擁有五個席次，雖然點人頭表決不會贏，但是透過一次次精實的議題討論和法案推進，時代力量的立場和價值更加堅定、明朗。究竟政治工作實況是如何？人民期待的新國會是否真的理想成真？在過去這一年半的過程中，最有成就感的又是什麼呢？面對下一步地方政治的改革又有什麼期許呢？來聽我們分享第一線的經驗吧！',
                            },
                        }
                    ],
                },
