...
const LandingData = Object.freeze({
  welcomeMessage: {
    ...
    zh: [
      <Paragraph key="p1">
        今年（2018）美東夏令會主題是「世代連結、台美一起」(Generations United, Taiwanese Americans Together)，著重在連結各世代台美人，凝聚台美雙方的力量，用行動來幫助台灣。
      </Paragraph>
      ,
      <Paragraph key="p2">
      ...
      ,
      <Paragraph key="p3">
        「台美一起」，是代表2018年，特殊的時間契機。“台美”，代表了台美關係，也代表了台美人。——面臨台美兩邊都是新政府的新時代，我們希望兩國政府都能為人民帶來更好的生活，也希望兩國的關係能夠進入更好的新紀元！——面對台美人世代連結的時機，我們要 了解台美人所面臨的問題與困境，但同時也找出台美人在美國的優勢，介紹傑出的台美人，建立台美人的自信，開創新的契機。
      </Paragraph>
      ,
      <Paragraph key="p4">
        2018 美東夏令會由三個台美人組織共同籌備，也代表了三個夏令會的參加群體：Taiwanese American Conference – East Coast (TACEC, 第一代台美移民，夏令會的創始組織)、Taiwanese American Next Generation (TANG, 第二代及以後的台美人) 以及海外台灣青年陣線 (Overseas Taiwanese for Democracy, OTD, 太陽花後成立的第一代年輕台美人組織)。
      </Paragraph>
      ,
      <Paragraph key="p5">
  ...
  deadlines: {
    en:
      <div>  <b>Registration Deadlines: </b><br />
        Early bird (online): <b>Mon, April 30</b> <br />
        Regular Online registration: <b>Friday, June 1</b> <br />
        Late registration (online only): <b>Sunday, June 10</b>
      </div>,
    zh:
      <div><b>報名截止日期: </b><br />
        早鳥 (線上報名): <b>星期一, 四月 三十號</b> <br />
        線上報名: <b>星期五, 6月 一號</b> <br />
